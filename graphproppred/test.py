...
def main():
    ...
    dataset = pickle.load(open('/home/haotao/GNN-MoE/mol/two_hop_dataset.pkl', 'rb'))
    ...
    if args.gnn == 'gin':
        ...
        model = GNN(gnn_type = 'gcn', num_tasks = dataset.num_tasks, num_layer = args.num_layer, emb_dim = args.emb_dim, drop_ratio = args.drop_ratio, virtual_node = False, hop=args.hop).to(device)
    elif args.gnn == 'gcn-spmoe':
        model = GNN(gnn_type = 'gcn', num_tasks = dataset.num_tasks, num_layer = args.num_layer, emb_dim = args.emb_dim, drop_ratio = args.drop_ratio, virtual_node = False, moe='sparse', hop=args.hop).to(device)
